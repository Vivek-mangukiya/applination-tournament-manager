...
const PoolsSummary = (props) => {
  ...
  const [commonState, setCommonState] = useState(
            ()=>{
              ...
              let FalseArray = [];
              let searchValues = [];
              let len=poolListData !== undefined && poolListData !== null &&
                      poolListData.summary!==null && poolListData.summary!==undefined?
  ...
  commonState.poolListData.map((values,i)=>{
    ...
    if (commonState.searchedItem[i].length && commonState.searchedItem[i][0]!=="") {
     let s = commonState.poolListData[i].filter((data) => {
        ...
        return (
         data!==null &&(data.team_name!==null && data.team_name.toString().match(regExp)
          ||
          data.rank!==null && data.rank.toString().match(regExp) ||
          data.match_wins!==null && data.match_wins.toString().match(regExp) ||
          data.match_losses!==null && data.match_losses.toString().match(regExp) ||
          data.game_win_percent!==null && data.game_win_percent.toString().match(regExp) ||
          data.game_wins!==null && data.game_wins.toString().match(regExp) ||
          data.game_losses!==null && data.game_losses.toString().match(regExp) ||
          data.match_win_percent!==null && data.match_win_percent.toString().match(regExp) ||
          data.points_for!==null && data.points_for.toString().match(regExp) ||
          data.against!==null && data.against.toString().match(regExp) ||
          data.point_percent!==null && data.point_percent.toString().match(regExp))
        );
      });
  ...
  for(var i = 0;i<len;i=i+1){
    ...
    if (FNsortType[i] === true && commonState.FNclicked[i] === true){
      sortedList = options;
      let sorted = options[i].sort((a, b) => a.team_name.localeCompare(b.team_name));
      sortedList[i] = sorted;
    }
    ...
    if (RankType[i] === true && commonState.Rankclicked[i] === true){
      ...
      let sorted = options[i].sort(
        (a, b) =>
          ...
          (b.rank === null ? 'null'.match(/\d+/) : b.rank.toString().match(/\d+/))
    ...
    if (RankType[i] === false && commonState.Rankclicked[i] === true){
      ...
      let sorted = options[i].sort(
        (a, b) =>
          ...
          (a.rank === null ? 'null'.match(/\d+/) : a.rank.toString().match(/\d+/))
      );
      sortedList[i] = sorted;
    }
  }
  ...
  for(var i = 0;i<len;i=i+1){
    ...
    if (PointsForsortType[i] === true && commonState.PointsForclicked[i] === true){
      sortedList = options;
      let sorted=  options[i].sort(
        (a, b) => a.points_for.toString() - b.points_for.toString()
      );
      sortedList[i] = sorted;}
    if (PointsForsortType[i] === false && commonState.PointsForclicked[i] === true){
      sortedList = options;
      let sorted= options[i].sort(
    ...
    if (AgainstsortType[i] === false && commonState.Againstclicked[i] === true){
      sortedList = options;
      let sorted= options[i].sort(
    ...
    if (PointPercentsortType[i] === true && commonState.PointPercentclicked[i] === true){
      sortedList = options;
      let sorted= options[i].sort(
  ...
  const ListItems = ({first, second}) => {
    console.log('sortedvalueList : '+sortedList, 'second :'+second , 'first'+first)
    ...
    return items.map((item, i) => {
      ...
      return (
        <li
          ...
          style={{ cursor: 'context-menu', padding:"0px", margin:"0px", height:40 }}
          // onClick={() => {
    ...
    <div className="pools pt-4" style={{paddingBottom:"100px"}}>
            ...
            <div className="col-6 p-0 m-0">
              <div className="row p-0 m-0 mr-2">
                ...
                <div className="col-1 m-0 p-0">
                  <PoolsScheduleDropdown>
                    {poolListData !== undefined && poolListData !== null &&
                    poolListData.summary!==null && poolListData.summary!==undefined && poolListData.summary.length>0 && 
                     poolListData.summary.map((individualSummary, i) => (
                        <li
                          key={i}
                          onClick={() =>
      ...
      {/* table */}
       ...
       {/* table */}
        ...
        { commonState.poolListData!==null && commonState.poolListData!==undefined && commonState.poolListData.length>0
                                    ...
                                    <div className="row mx-0 px-0">
                                      <div className="col-11 text-center m-auto px-0">
                                        ...
                                        <div className="col-6 m-0 pt-2 d-flex justify-content-start">
                                          <h6> Pool {index+1}: {commonState.poolNames[index]}</h6>
                                        </div>
                                          ...
                                          <div className="col-6 m-0 p-2 d-flex justify-content-start" >
                                            <input
                                              ...
                                              style={{padding:"0px",margin:"0px", paddingLeft: 50}}
                                            ...
                                            <div className="row m-0 p-0 headerTable">
                                              ...
                                              <div className="col-2 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onFNSort(commonState.FNsortType[index],index)}
                                                  alt=""
                                                />
                                                TEAM
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onRankSort(commonState.RankType[index],index)}
                                                  alt=""
                                                />
                                                RANK
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onLNSort(commonState.LNsortType[index],index)}
                                                  alt=""
                                                />
                                                MATCH WINS
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onIDSort(commonState.IDsortType[index],index)}
                                                  alt=""
                                                ></img>
                                                LOSSES
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onPointsSort(commonState.PointssortType[index],index)}
                                                  alt=""
                                                ></img>
                                                WIN %
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onLocSort(commonState.LocsortType[index],index)}
                                                  alt=""
                                                ></img>
                                                GAMES WINS
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onStatusSort(commonState.StatussortType[index],index)}
                                                  alt=""
                                                ></img>
                                                LOSSES
                                              </div>
                                                ...
                                                <img
                                                  ...
                                                  onClick={() =>
                                                    onMatchWinPercentSort(
                                                      commonState.MatchWinPercentsortType[index],index
                                                    )
                                                  }
                                                  alt=""
                                                ></img>
                                              ...
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() =>
                                                    onPointsForSort(commonState.PointsForsortType[index],index)
                                                  }
                                                  alt=""
                                                ></img>
                                                POINTS FOR
                                              ...
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() => onAgainstSort(commonState.AgainstsortType[index],index)}
                                                  alt=""
                                                ></img>
                                                AGAINST
                                              </div>
                                              <div className="col-1 m-0 p-0 d-flex justify-content-center align-items-center">
                                                <img
                                                  ...
                                                  onClick={() =>
                                                    onPointPercentSort(commonState.StatussortType[index],index)
                                                  }
                                                  alt=""
                                                ></img>
                                                POINT %
