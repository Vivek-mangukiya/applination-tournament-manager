                  ...
                  for (let i = 0; i < Number(props.match.params.courts); i++) {
                      ...
                      for(let j=0;j<Number(data.length);j++){
                        ...
                        gameIndexData.push(
                         ...
                         temp.schedules[i]={ court_no: i + 1, games:gameIndexData, label: 'pool '+(i+1) };
